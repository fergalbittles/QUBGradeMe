...
final class ControllerTest extends TestCase {
    ...
    public function testController_successfulRequest() {
        ...
        $this->assertEquals($output["sorted_modules"][0]["module"], "Concurrent Programming");
        $this->assertEquals($output["sorted_modules"][0]["marks"], 87);
        $this->assertEquals($output["sorted_modules"][1]["module"], "Databases");
        $this->assertEquals($output["sorted_modules"][1]["marks"], 74);
        $this->assertEquals($output["sorted_modules"][2]["module"], "Cloud Computing");
        $this->assertEquals($output["sorted_modules"][2]["marks"], 68);
        $this->assertEquals($output["sorted_modules"][3]["module"], "Cyber Security");
        $this->assertEquals($output["sorted_modules"][3]["marks"], 56);
        $this->assertEquals($output["sorted_modules"][4]["module"], "Programming");
        $this->assertEquals($output["sorted_modules"][4]["marks"], 32);
    }
